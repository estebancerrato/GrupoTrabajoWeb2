...
<?php
    ...
    if(isset($_POST['accion'],$_GET['id'])){
        ...
        if(($_POST['accion']==2)&&($_GET['id']!='')){
            $paqueteID = $_GET['id'];
            $data=($objetoTabla->obtenerPaquete($paqueteID));  
            
            $cadena="id=".$paqueteID."&accion=2&dir=addeditPaquete&u=1";
            echo
            "
             <form name='formulario' id='formulario' method='POST' action='acciones.php?" . $cadena . "'> <br><br>
                ...
                <select name='cmb_buses' id='cmb_buses'  class='form-control'>
                          <option value='$data[bus_codigo]' selected >$data[BusNombre]</option>";
            ...
            <div class='row justify-content-center'>
                ...
                <select name='cmb_clientes' id='cmb_clientes'  class='form-control'>
                          <option value='$data[cliente_cedula]' selected >$data[ClienteNombre]</option>";
                ...
                <div class='col-3'>
                <input type='text' name='speso'  id='speso' class='form-control' value='$data[paquete_peso_libras]' aria-label='default input example' required>
                </div>
            </div><br>
                ...
                <div class='row justify-content-center'>
                    ...
                    <div class='col-3'>
                    <input type='date' name='fechaenvio'  id='fechaenvio' class='form-control' value='$data[paquete_fecha_hora_envio]' aria-label='default input example' required>
                    </div>                
                    ...
                    <div class='col-3'>
                    <input type='date' name='fechaentrega'  id='fechaentrega' class='form-control' value='$data[paquete_fecha_hora_entrega]' aria-label='default input example' required>
                    </div>
                </div><br>
                ...
                <select name='cmb_tipo_paquetes' id='cmb_tipo_paquetes'  class='form-control'>
                          <option value='$data[tipo_paquete_codigo]' selected >$data[tipo_paquete_nombre]</option>";
                    ...
                    <select name='scmb_estado' id='scmb_estado'  class='form-control'>
                            <option value='$data[paquete_estado]' selected >$data[paquete_estado]</option>
                ...
                <div class='row justify-content-center'>
                    ...
                    <div class='col-8'>
                    <textarea id='observaciones' name='observaciones' rows='6' required class='form-control'>$data[paquete_descripcion]</textarea>
                    </div>
               </div><br>
        ...
        $cadena="id=x&accion=1&dir=addeditPaquete&u=1";
        echo
        "
             <form name='formulario' id='formulario' method='POST' action='acciones.php?" . $cadena . "'> <br><br>
                        <input type='hidden' name='accion' id='accion' value=''>
            ...
            <div class='row justify-content-center'>
                ...
                <div class='row justify-content-center'>
                    ...
                    <div class='col-3'>
                    <input type='date' name='fechaenvio'  id='fechaenvio' class='form-control' aria-label='default input example' required>
                    </div>                
                    ...
                    <div class='col-3'>
                    <input type='date' name='fechaentrega'  id='fechaentrega' class='form-control' aria-label='default input example' required>
                    </div>
                </div><br>
